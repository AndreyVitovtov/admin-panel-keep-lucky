...
<?php if (isRole('superadmin') || isset($accesses['users']['details'])): ?>
...
<?php if (isRole('superadmin') || isset($accesses['users']['top_up_balance'])): ?>
...
<?php if (isRole('superadmin') || isset($accesses['users']['write_off_balance'])): ?>
